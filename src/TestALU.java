...
public class TestALU {
    public static void main(String[] args) {
        ...
        boolean[] binC = {true, false, false, false,false, false, false, false,false, false, false, false,false, false, false, false,false, false, false, false,false, false, false, false,false, false, true, true, true, true, false, true};
        ...
        boolean[] addCA = { true, true, true, true, false,true ,true, true, false,false, false,true,false,true,false,false, false,true,true,false,false,false,true,false,false, false, true,true, true, true, true, true};

        boolean[] subCA = {true, true,false,false,true, false,false,false,true, true, true,false,true,false,true,true,true,false,false,true,true,true,false,true
        ...
        if(!Arrays.equals(binRes, subCA)) {
            ...
            System.out.println("ALU result of binC - binA: " + Binary.toString(binRes));
            System.out.println("Correct result of binA - binB: " + Binary.toString(subCA));
        } else if(alu.getZeroFlag() || !alu.getCarryFlag() || !alu.getOverflowFlag()) {
            System.out.println("FAIL Test 9 ALU flags:");
            System.out.println("ALU result: zeroFlag = " + alu.getZeroFlag()
                    + "; carryFlag = " + alu.getCarryFlag()
